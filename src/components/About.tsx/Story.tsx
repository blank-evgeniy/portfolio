        ...
        <div className="mx-auto max-w-[1000px] px-4 pt-20">
            ...
            <Reveal>
                ...
                <p className="text-xl">
                    ...
                    технологиями, спортом, музыкой и многими другими вещами,
                    которые дают мне возможность развиваться и получать от жизни
                    все.
                </p>
            </Reveal>
            ...
            <Reveal>
                <p className="pt-8 text-xl">
                    ...
                    обучением в ВУЗе я изучаю веб-разработку. Начиная с базовых
                    уроков по верстке на HTML и CSS, я добрался до экосистемы
                    такой популярной библиотеки как <Strong>React</Strong>, в
                    которую углубляюсь по сей день.
                </p>
            </Reveal>
