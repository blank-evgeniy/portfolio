...
export const MenuIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg
...
export const EmailIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
...
export const HtmlIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
...
export const CssIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg viewBox="0 0 128 128" width={size} height={size}>
            <path
                fill="#1572B6"
...
export const JSIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg viewBox="0 0 128 128" width={size} height={size}>
...
export const ReactIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg viewBox="0 0 128 128" width={size} height={size}>
            <g fill="#61DAFB">
...
export const ReduxIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg viewBox="0 0 128 128" width={size} height={size}>
            <path
                fill="#764abc"
...
export const TSIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg viewBox="0 0 128 128" width={size} height={size}>
...
export const SASSIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg viewBox="0 0 128 128" width={size} height={size}>
            <path
                fillRule="evenodd"
...
export const TailwindIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg viewBox="0 0 128 128" width={size} height={size}>
            <path
...
export const BootstrapIcon: React.FC<IconProps> = ({ size = 32 }) => {
    return (
        <svg viewBox="0 0 128 128" width={size} height={size}>
            <defs>
                <linearGradient
